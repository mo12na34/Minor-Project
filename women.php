...
<header id="aa-header"> 
  ...
  $total=0;
	...
	?>
                  <li> <a class="aa-cartbox-img" href="#"><img src="admin_area/product_images/women/<?php echo $product_image; ?>" alt="img"></a>
                  ...
                  <?php }}?> 
                  <li> <span class="aa-cartbox-total-title"> Total </span> <span class="aa-cartbox-total-price"><?php total_price2(); ?></span> </li>
